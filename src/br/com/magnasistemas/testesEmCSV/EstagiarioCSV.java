...
public class EstagiarioCSV {
	public static void main(String[] args) {
		...
		String path = "C:\\Users\\Magna\\eclipse-workspace\\PessoaEntidade\\src\\CSVs\\EstagiarioCSV.csv";
		...
		try (BufferedReader br = new BufferedReader(new FileReader(path))) {
			...
			while (linhas != null) {
				...
				Estagiario estagio = new Estagiario.Builder().nome(nome).genero(genero).etnia(etnia)
						...
						.nomeDaEmpresa(nomeDaEmpresa).diaDeInicio(LocalDate.of(anoDeInicio, mesDeInicio, diaDeInicio))
		...
		try {
			...
			FileWriter file = new FileWriter(
					"C:\\Users\\Magna\\eclipse-workspace\\PessoaEntidade\\src\\CSVSaida\\EstagiarioCSV.csv");
		...
		list.get(0).aprenderNovasFalas("Acho que vou voltar a estudar");
