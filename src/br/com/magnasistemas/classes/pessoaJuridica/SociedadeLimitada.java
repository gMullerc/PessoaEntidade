...
public class SociedadeLimitada extends Sociedade {

	public SociedadeLimitada(Builder builder) {
	...
	public static class Builder {
		...
		public SociedadeLimitada build() {
			return new SociedadeLimitada(this);
		}
